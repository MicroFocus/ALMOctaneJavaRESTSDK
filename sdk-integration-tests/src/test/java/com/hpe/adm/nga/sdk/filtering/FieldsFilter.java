...
public class FieldsFilter extends TestBase {
    ...
    public void testFieldsFilterWithIdOneField() throws Exception {
        ...
        List<String> fields = Arrays.asList("attachments");
        ...
        Assert.assertTrue(isOnlyRequestedFieldsExistInEntity(getEntity, fields));
    }

    @Test
    public void testFieldsFilterWithIdMultipleFields() throws Exception {

        List<String> fields = Arrays.asList("attachments", "creation_time", "has_attachments");
    ...
    public void testFieldsFilterMultipleFields() throws Exception {
        ...
        List<String> fields = Arrays.asList("done_work", "description", "expected_velocity");
        ...
        Assert.assertTrue(getIdFromEntityModelCollection(getEntity, fields));
    }
