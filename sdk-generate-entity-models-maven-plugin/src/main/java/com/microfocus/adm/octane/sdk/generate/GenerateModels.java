...
import com.microfocus.adm.octane.sdk.authentication.SimpleClientAuthentication;
import com.microfocus.adm.octane.sdk.metadata.EntityMetadata;
import com.microfocus.adm.octane.sdk.metadata.FieldMetadata;
import com.microfocus.adm.octane.sdk.metadata.Metadata;
...
import com.microfocus.adm.octane.sdk.model.StringFieldModel;
 ...
 * This class generates models based on the {@link com.microfocus.adm.octane.sdk.model.TypedEntityModel},
 * entity lists based on {@link com.microfocus.adm.octane.sdk.entities.TypedEntityList} and Lists &amp; Phases objects
        ...
        final TreeMap<String, List<String>> collectedReferences = fieldMetadata.stream()
                ...
                .collect(Collectors.toMap(FieldMetadata::getName, fieldMetadata1 -> {
                    ...
                    if (fieldMetadata1.getName().equals("phase") && availablePhases.contains(className)) {
                        references.add("com.microfocus.adm.octane.sdk.enums.Phases." + className + "Phase");
                        ...
                        if ((!entityMetadatum.getName().equals("list_node")) && (fieldMetadata1.getFieldTypedata().getTargets()[0].getType().equals("list_node"))) {
                            ...
                            references.add("com.microfocus.adm.octane.sdk.enums.Lists." + listName);
                        } else {
