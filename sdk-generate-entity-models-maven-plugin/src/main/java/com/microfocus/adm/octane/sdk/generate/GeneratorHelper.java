 ...
 */
package com.microfocus.adm.octane.sdk.generate;

import com.microfocus.adm.octane.sdk.metadata.EntityMetadata;
import com.microfocus.adm.octane.sdk.metadata.FieldMetadata;
import com.microfocus.adm.octane.sdk.metadata.features.Feature;
import com.microfocus.adm.octane.sdk.metadata.features.RestFeature;
import com.microfocus.adm.octane.sdk.metadata.features.SubTypesOfFeature;
import com.microfocus.adm.octane.sdk.model.*;
...
public final class GeneratorHelper {
    ...
    public static final class EntityMetadataWrapper {
        com.microfocus.adm.octane.sdk.model.EntityMetadata.AvailableMethods[] availableMethods = new com.microfocus.adm.octane.sdk.model.EntityMetadata.AvailableMethods[0];
        String url;

        public com.microfocus.adm.octane.sdk.model.EntityMetadata.AvailableMethods[] getAvailableMethods() {
    ...
    public static EntityMetadataWrapper entityMetadataWrapper(final EntityMetadata entityMetadata) {
        ...
        entityMetadataWrapper.availableMethods = new com.microfocus.adm.octane.sdk.model.EntityMetadata.AvailableMethods[methods.length];
        for (int i = 0; i < methods.length; ++i) {
            switch (methods[i]) {
                case "GET":
                    entityMetadataWrapper.availableMethods[i] = com.microfocus.adm.octane.sdk.model.EntityMetadata.AvailableMethods.GET;
                    break;
                case "POST":
                    entityMetadataWrapper.availableMethods[i] = com.microfocus.adm.octane.sdk.model.EntityMetadata.AvailableMethods.CREATE;
                    break;
                case "PUT":
                    entityMetadataWrapper.availableMethods[i] = com.microfocus.adm.octane.sdk.model.EntityMetadata.AvailableMethods.UPDATE;
                    break;
                case "DELETE":
                    entityMetadataWrapper.availableMethods[i] = com.microfocus.adm.octane.sdk.model.EntityMetadata.AvailableMethods.DELETE;
                    break;
            }
        }
