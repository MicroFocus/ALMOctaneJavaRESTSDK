 ...
 * This class generates models based on the {@link com.microfocus.adm.almoctane.sdk.model.TypedEntityModel},
 * entity lists based on {@link com.microfocus.adm.almoctane.sdk.entities.TypedEntityList} and Lists &amp; Phases objects
...
public class GenerateModels {
    ...
    public GenerateModels(final File outputDirectory) {
        final File packageDirectory = new File(outputDirectory, "/com/microfocus/adm/almoctane/sdk");
        ...
        final TreeMap<String, List<String>> collectedReferences = fieldMetadata.stream()
                ...
                .collect(Collectors.toMap(FieldMetadata::getName, fieldMetadata1 -> {
                    ...
                    if (fieldMetadata1.getName().equals("phase") && availablePhases.contains(className)) {
                        references.add("com.microfocus.adm.almoctane.sdk.enums.Phases." + className + "Phase");
                        ...
                        if ((!entityMetadatum.getName().equals("list_node")) && (fieldMetadata1.getFieldTypedata().getTargets()[0].getType().equals("list_node"))) {
                            ...
                            references.add("com.microfocus.adm.almoctane.sdk.enums.Lists." + listName);
                        } else {
