...
//	                    		request.getHeaders().setBasicAuthentication(userName,password);
                                ...
                                authentication.put("user", userName);
                                authentication.put("password", password);
                                JSONObject objBase = new JSONObject(authentication);
                                String strJasonEntityModel = objBase.toString();
                                request.setContent(ByteArrayContent.fromString(null, strJasonEntityModel));
